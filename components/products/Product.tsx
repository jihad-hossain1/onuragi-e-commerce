...
const Product = ({ product }) => {
  return (
    <div className="group relative border border-gray-100 rounded-md shadow-sm hover:shadow-lg transition-all duration-300 max-sm:p-1 md:p-4 pb-4 bg-white hover:bg-gray-50">
      ...
      {/* Product Info */}
      <h4 className="text-sm mt-2 max-sm:text-[12px] group-hover:text-blue-600 transition-colors duration-300">
      ...
      <div className="flex items-center justify-between">
        <h4 className=" text-gray-600">
          <span className="text-sm max-sm:text-[12px] font-bold">{`${product?.price}.00`}</span>
